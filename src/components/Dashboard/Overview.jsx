...
import { OverviewHeaderSkeleton } from "./Skeletons/OverviewHeaderSkeleton";
import { BalanceCardSkeleton } from "./Skeletons/BalanceCardSkeleton";
import { AccountsHeaderSkeleton } from "./Skeletons/AccountsHeaderSkeleton";
import { AccountSummarySkeleton } from "./Skeletons/AccountSummarySkeleton";
import { StatisticsHeaderSkeleton } from "./Skeletons/StatisticsHeaderSkeleton";
import { StatisticsRowsSkeleton } from "./Skeletons/StatisticsRowsSkeleton";
  ...
  return (
    <div className="flex flex-col xl:flex-row w-full min-h-full gap-6 xl:gap-12 2xl:gap-16 px-3 sm:px-2 xl:px-6">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex items-center gap-4 sm:gap-8 w-full mb-6">
              ...
              <p className="w-16 sm:w-20 text-lg sm:text-xl font-medium">
                Income
              </p>

              <div className="flex-1 h-3 sm:h-4 rounded overflow-hidden invisible md:visible">
                <div
      ...
      <div className="hidden xl:flex xl:flex-[2] min-h-125 flex-col justify-between mb-12">
        {loading ? <TransactionsOverviewSkeleton /> : <TransactionsOverview />}
        {loading ? (
          <UpgradeCardSkeleton />
        ) : (
          <div
