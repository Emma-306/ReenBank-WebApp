  ...
  return (
    <>
      <div className="w-full">
        {loading ? (
          <div className="w-full grid gap-6 p-6">
            {[...Array(1)].map((_, index) => (
              <div
                key={index}
                className="w-full h-32 bg-green-400/20 rounded-xl animate-pulse"
              />
            ))}
          </div>
        ) : (
          ...
          {visibleTransactions < selectedAccount.transactions.length &&
            (loading ? (
              <div className="flex justify-center mt-8">
                <div className="px-6 py-3 bg-purple-900/20 rounded-lg animate-pulse">
