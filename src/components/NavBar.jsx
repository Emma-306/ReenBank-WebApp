    ...
    <div className='w-full flex items-center justify-between mb-20'>
        <div className='flex flex-row items-center gap-12 xl:gap-28'>
          ...
          <nav className='flex flex-row items-center text-lg gap-6 xl:gap-12'>
            ...
            <a href="contact-us" className='hover:scale-110 transition-all duration-300 hover:underline underline-offset-8 hover:text-green-900'>Contact Us</a>
          </nav>
        </div>
        <button className='border-3 border-green-600/50 px-6 sm:px-8 py-3 rounded-md font-semibold text-green-600/50 hover:bg-green-800/80 hover:text-white transition-all duration-300 cursor-pointer'>Login</button>
    </div>
  )
}
